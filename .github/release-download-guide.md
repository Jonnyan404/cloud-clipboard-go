...
- **CPU 架构**在路由器上执行 `cat /etc/apk/arch`或者`opkg print-architecture`，或对照型号。软路由（x86）选 `x86_64`；常见家用路由多在 `arm_cortex-a7` / `arm_cortex-a9` 一档。
